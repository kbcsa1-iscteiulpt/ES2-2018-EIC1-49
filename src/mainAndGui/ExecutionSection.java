			...
			public void actionPerformed(ActionEvent e) {
				if (nameDescription.getProblemName().getText().isEmpty()
					...
					try {
						...
						try {
							support.SendEmail(adminEmail, email.getEmail().getText(), adminEmail, "There was a problem","There was a problem running the problem you requested, please try again.\r\n"
					...
					try {
						...
						support.SendEmail(adminEmail, email.getEmail().getText(),adminEmail, subject, "Muito obrigado por usar esta plataforma de otimiza��o. Ser� informado por email\r\n"
